// @ts-nocheck — ahmeetseker/ai-btn-deneme deposundan (Button Lab #3) vendored
// WebGL ızgara shader'ı; `ogl` üstünde. Tip düzeltmesi yerine kaynakla birebir
// tutulur ki lab'daki güncellemeler kolay taşınsın. jsdom/WebGL'siz ortamda
// sessizce hiç kurulmaz (try/catch) — buton camı statik kalır.
...
const RippleGrid = ({
  ...
  useEffect(() => {
    ...
    // WebGL yoksa (jsdom, eski cihaz) shader hiç kurulmaz — buton statik kalır.
    let renderer;
    try {
