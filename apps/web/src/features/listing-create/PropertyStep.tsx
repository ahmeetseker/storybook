...
/* Ölçü grubunun başlığı kategoriye göre değişir: kullanıcı hangi ölçüleri
   girdiğini kart başlığından okur, alan etiketlerini taramak zorunda kalmaz. */
const measureGroupTitle: Record<Exclude<PropertyFamily, ''>, string> = {
  land: 'Arsa ölçüleri ve imar',
  residential: 'Konut ölçüleri',
  commercial: 'İş yeri ölçüleri',
  building: 'Bina ölçüleri',
}
  ...
  return (
    <section className={styles.stepSection} aria-labelledby="property-step-title">
      ...
      <ListingGroup
        ...
        title="İlan amacı ve mülk türü"
        description="Bu seçim arama filtrelerini ve sonraki adımlarda sorulacak alanları belirler."
      ...
      >
        ...
        <div className={styles.formGrid}>
          ...
          <ListingField
            ...
            description={value.family ? undefined : 'Önce mülk türünü seçin.'}
          >
            <GlassSelect
              material="flat"
              size="lg"
      ...
      <ListingGroup
        ...
        title="Yayınlama yetkisi"
        description="Seçtiğiniz rol, son adımdaki EİDS kontrolünün neyi sorgulayacağını belirler."
        requirement="required"
      >
        <fieldset
      ...
      {value.family ? (
        <ListingGroup
          ...
          title={measureGroupTitle[value.family]}
          description="Girdiğiniz ölçüler ilan kartında ve birim fiyat hesabında kullanılır."
          requirement="required"
        >
          {value.family === 'land' ? (
            <div className={styles.formGrid}>
            ...
            <div className={styles.formGrid}>
              ...
              >
                <input
                  ...
                  {...listingFieldA11y('property-floor-count', errors.floorCount)}
                />
              </ListingField>
              <ListingField
